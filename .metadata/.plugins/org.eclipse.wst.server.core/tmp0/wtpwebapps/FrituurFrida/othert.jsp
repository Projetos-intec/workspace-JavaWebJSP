...
<body>
	...
	<div id='demotitel'>
		...
		<h1>Frida Frituut Registreren</h1>
	</div>
	</header>
	<nav>
	<ul>
	...
	<article>
	<h2>Maak nu uw registracie en dan bestaling online</h2>
	<br />
	Login
	<hr />
	<form action="AddUsuario" method="POST">
		...
		Endereço: <input type="text" name="endreco" />
		Tel: <input type="text" name="endreco" />
		<br />  <input type="submit" value="Register" name="regs"  />
